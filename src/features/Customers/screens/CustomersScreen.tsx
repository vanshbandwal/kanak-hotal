        ...
        },
        {
            ...
            render: (c: any) => (
                <div className="customer-actions">
                    <button className="action-btn view"  onClick={() => handleView(c)}        title="View">   <EyeIcon  /></button>
                    <button className="action-btn edit"  onClick={() => handleEdit(c)}        title="Edit">   <EditIcon /></button>
                    <button className="action-btn delete" onClick={() => handleDeleteClick(c)} title="Delete"><TrashIcon /></button>
                </div>
            )
        }
    ];
                ...
                <div className="customer-view-overlay" onClick={() => setViewCustomer(null)}>
                    <div className="customer-view-drawer" onClick={e => e.stopPropagation()}>
                        <div className="drawer-header">
                            ...
                            <button className="drawer-close" onClick={() => setViewCustomer(null)}><CloseIcon /></button>
                        </div>
